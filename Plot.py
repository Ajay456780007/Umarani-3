...
class ALL_GRAPH_PLOT:
    ...
    def load_kf_values(self, DB):
        A = np.load(f"Analysis/KF_Analysis/{DB}/ACC_2.npy")*100
        B = np.load(f"Analysis/KF_Analysis/{DB}/SEN_2.npy")*100
        C = np.load(f"Analysis/KF_Analysis/{DB}/SPE_2.npy")*100
        D = np.load(f"Analysis/KF_Analysis/{DB}/F1score_2.npy")*100
        E = np.load(f"Analysis/KF_Analysis/{DB}/REC_2.npy")*100
        F = np.load(f"Analysis/KF_Analysis/{DB}/PRE_2.npy")*100
