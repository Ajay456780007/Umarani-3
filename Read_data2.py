...
#
#     signal_paths = data["filename_hr"].values[:100]
#
...
#
#     complete_len =[]
#     complete_splitted_P, complete_splitted_Q, complete_splitted_R, complete_splitted_S, complete_splitted_T = [], [], [], [], []
#
...
#
#         # complete_splitted_P.append(p_peak_splitted)
#         # complete_splitted_Q.append(q_peak_splitted)
#         # complete_splitted_R.append(r_peak_splitted)
#         # complete_splitted_S.append(s_peak_splitted)
#         # complete_splitted_T.append(t_peak_splitted)
#
...
#         final_labels = []
#     #
# # max_len1 = max(len(m) for mm in complete_splitted_P for m in mm)
# # max_len2 = max(len(m) for mm in complete_splitted_Q for m in mm)
# # max_len3 = max(len(m) for mm in complete_splitted_R for m in mm)
# # max_len4 = max(len(m) for mm in complete_splitted_S for m in mm)
# # max_len5 = max(len(m) for mm in complete_splitted_T for m in mm)
# # #
# # max_len = max(max_len1, max_len2, max_len3, max_len4, max_len5)
# # max_len = 69
#     peak_splits =[complete_splitted_P,complete_splitted_Q,complete_splitted_R,complete_splitted_S,complete_splitted_T]
#     new_signal = signal
